...
<body style="padding:0px; margin:0px; font-family:Arial, Verdana;background-color:#fff;">
    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        ...
        <div data-u="slides" style="position: absolute; left: 0px; top: 0px; width: 1500px;
            ...
            <div>
                <img data-u="image" src="images/full-width/slide1new.png" alt="" />
            </div>
            <div>
                <img data-u="image" src="images/full-width/slide 2.png" alt="" />
            </div>
            <div>
                <img data-u="image" src="images/full-width/slide 3.png" alt="" />
            </div>
        </div>
    ...
    <!-- Jssor Slider End -->
    <a href="Banking management system new.pdf" target="_blank">Download PDF Document</a>
</body>
</html>