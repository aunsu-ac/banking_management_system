...
<br><br><br><br>
        ...
        <h3><strong>Sign-up</strong> as a new Coustomer</h3>
        <hr>
        <?php if(isset($_GET['msg'])) echo $_GET['msg']; ?>
        <form class="form-inline" name="Login Form" action="s_up.php" method="post" >
    ...
    <div class="form-group">
        ...
        <textarea name="add" class="form-control" cols="50" rows="4" wrap="virtual" required></textarea>
    </div><br><br>
    <div class="form-group">
    ...
    <br><br>
        <div class="form-group">
        	...
        	&nbsp;<input type="radio" class="form-group" name="gender" value="male">MALE
        	&nbsp;<input type="radio" class="form-group" name="gender" value="female">FEMALE
        </div>
        <br><br>
        <div class="form-group">
        <label for="">Contact no: </label>
        <input type="text" name="con" class="form-control" placeholder="Enter Your Contact No" required>
    </div>
            <div class="form-group">
            ...
            <div class="form-group"> 
            <button name="btnu" id="btnu" class="form-control" class="btn btn-block btn-info">Sign-up</button>
            </div>
        </form>
        <br>
